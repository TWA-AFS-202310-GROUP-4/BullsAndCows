...
namespace BullsAndCowsTest
{
    public class BullsAndCowsGameTest
    {
        ...
        [InlineData("1243")]
        [InlineData("2134")]
        public void Should_return_2A2B_when_guess_number_and_secrete_are_partially_same(string guessNumber)
        {
            //Given
            string secrete = "1234";
        ...
        [InlineData("7843")]
        [InlineData("2178")]
        public void Should_return_0A2B_when_guess_number_and_secrete_are_partially_same(string guessNumber)
        {
            //Given
            string secrete = "1234";
